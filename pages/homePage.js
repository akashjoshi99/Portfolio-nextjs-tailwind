...
import heroImage from "../public/images/IMG_8783.jpg";
				...
				<div className="flex justify-between text-center md:mx-20 md:pt-32 pt-28 ">
					<div className=" w-96 h-96 shadow-xl rounded-full relative px-10 hidden md:block">
						<Image
							...
							layout="fill"
							objectFit="cover"
							className=" object-center rounded-full cursor-pointer hidden md:block "
						/>
					</div>
					<div className="flex flex-col md:ml-20 mx-10 mt-10">
						<h1 className="font-bold text-7xl text-left mb-5">
							Hello, I am <span className="text-indigo-900">Akash</span>
						</h1>
